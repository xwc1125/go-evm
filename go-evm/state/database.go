...
type Database interface {
	...
	OpenTrie(root types.Hash) ( error)
...
//	}
//}
func NewDatabaseWithCache(cache int) Database {
	csc, _ := lru.New(codeSizeCacheSize)
	return &cachingDB{
		//db:            trie.NewDatabaseWithCache(db, cache),
		codeSizeCache: csc,
...
// OpenTrie opens the main account trie.
func (db *cachingDB) OpenTrie(root types.Hash) ( error) {
	//	db.mu.Lock()
	//	defer db.mu.Unlock()
	//
